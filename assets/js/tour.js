...
(function () {
  ...
  function init() {
    ...
    stackElC.innerHTML = '<span style="display:block;line-height:1.5;opacity:0.625;">Copyright <i class="ph ph-copyright" style="font-size:0.85em;vertical-align:-0.1em;"></i> ' + new Date().getFullYear() + '</span>';

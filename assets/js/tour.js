...
(function () {
  ...
  function init() {
    ...
    stackElC.innerHTML = '<span style="display:inline-block;line-height:1.5;opacity:0.75;border:3px solid rgba(0,0,0,0.6);border-radius:4px;padding:0px 6px;box-shadow:1px 1px 4px rgba(0,0,0,0.25);">COPYRIGHT <i class="ph ph-copyright" style="font-size:0.85em;vertical-align:-0.1em;"></i> ' + new Date().getFullYear() + '</span>';

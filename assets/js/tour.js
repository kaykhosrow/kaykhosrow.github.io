...
(function () {
  ...
  styleEl.textContent = [
    ...
    '.tour-close-btn { pointer-events:auto !important; cursor:pointer !important; }',
  ...
  function init() {
    ...
    stackEl.innerHTML = '<div style="display:flex;justify-content:space-between;align-items:center;box-sizing:border-box;width:100%;font-size:1.5rem;opacity:0.75;letter-spacing:0.025em;text-transform:uppercase;border:3px solid rgba(0,0,0,0.625);border-radius:4px;padding:0px 9px;box-shadow:1px 1px 2.5px rgba(0,0,0,0.25);line-height:1.25;position:relative;top:-10px;margin-bottom:0.45em;"><span>Page Overview</span><span class="tour-close-btn" style="pointer-events:auto;cursor:pointer;"><i class="ph-bold ph-arrow-u-up-left" style="font-size:0.9em;vertical-align:-0.1em;margin-right:7.5px;"></i>Return to Home</span></div><span style="display:block;line-height:1.5;position:relative;top:2.5px;">Welcome to my page. Here you can explore my research, teaching, and conference activities, as well as selected code, cinematography, chess highlights and contact details for enquiries or collaboration.</span>';
    document.body.appendChild(stackEl);

    stackEl2 = document.createElement('div');
    stackEl2.id        = 'tourStack2';
    stackEl2.className = 'tour-stack';
    stackEl2.innerHTML = '<div style="display:flex;justify-content:space-between;align-items:center;box-sizing:border-box;width:100%;font-size:1.5rem;opacity:0.75;letter-spacing:0.025em;text-transform:uppercase;border:3px solid rgba(0,0,0,0.625);border-radius:4px;padding:0px 9px;box-shadow:1px 1px 2.5px rgba(0,0,0,0.25);line-height:1.25;position:relative;top:-17.5px;margin-bottom:0.45em;"><span>Core languages</span><span><i class="ph-bold ph-code" style="font-size:0.9em;vertical-align:-0.1em;margin-right:10px;"></i>HTML<span style="font-size:1.6em;line-height:0;vertical-align:-0.05em;">·</span>CSS<span style="font-size:1.6em;line-height:0;vertical-align:-0.05em;">·</span>JS</span></div><span style="display:block;line-height:1.5;position:relative;top:-5px;">This page was built in HTML, CSS and JavaScript. The layout and styling are handled in CSS, whereas JavaScript takes care of all the animations, navigation and interactions you see across the site.</span>';
    ...
    stackEl3.innerHTML = '<div style="display:flex;justify-content:space-between;align-items:center;box-sizing:border-box;width:100%;font-size:1.5rem;opacity:0.75;letter-spacing:0.025em;text-transform:uppercase;border:3px solid rgba(0,0,0,0.625);border-radius:4px;padding:0px 9px;box-shadow:1px 1px 2.5px rgba(0,0,0,0.25);line-height:1.25;position:relative;top:-10px;margin-bottom:0.45em;"><span>Optimal Viewing</span><span><i class="ph ph-browser" style="font-size:0.9em;vertical-align:-0.1em;margin-right:7.5px;"></i>Chrome</span></div><span style="display:block;line-height:1.5;position:relative;top:2.5px;">Designed for desktop. For an optimal experience, view at full screen width. Some elements might not display as intended on narrower windows.</span>';
    ...
    document.addEventListener('click', function (e) {
      ...
      if (e.target.closest('.tour-close-btn')) { hideAll(); return; }

...
(function () {
  ...
  function init() {
    ...
    stackEl.textContent = 'This site was built in HTML, CSS and JavaScript. The layout and styling are handled in CSS, whereas JavaScript takes care of all the animations, navigation and the interactions you see throughout the site. The source code is available in my online GitHub repository.';
